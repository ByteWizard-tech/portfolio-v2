...
const techStack: TechItem[][] = [
  ...
  [
    { name: "GradCAM", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/opencv/opencv-original.svg", url: "https://github.com/jacobgil/pytorch-grad-cam" },
    { name: "Spline", icon: "https://img.icons8.com/color/48/000000/3d-rotate.png", url: "https://spline.design" },
  ],
];
